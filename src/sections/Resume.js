    ...
    <section id="resume">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-5 md:gap-8 items-center">
        <div className="col-span-1 md:col-span-2">
          <OutboundLink
            href="https://drive.google.com/file/d/1jdlEKSzTmBXtitEHa5CQ9f88nrG2KVCJ/view"
            target="_blank"
        ...
        <div className="col-span-1 md:col-span-3">
          <h5 className="text-lg lg:text-xl font-semibold">
            To those who need a more organized and minimal version
          ...
          <Button
            ...
            onClick={() =>
              window.open("https://drive.google.com/file/d/1jdlEKSzTmBXtitEHa5CQ9f88nrG2KVCJ/view", "_blank")
            }
          />
        </div>
      </div>
